    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Update An Post!</h1>
            </div>
                    ...
                    <div class="col-6">
                        <div class="form-group row">
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                ...
                                <input type="text" class="form-control " id="title" name="title" placeholder="title" value="<?= $post['p_title'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                ...
                                <textarea class="form-control" id="" rows="8" name="excerpt" id="excerpt" value=""><?= $post['p_excerpt'] ?></textarea>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                ...
                                <select name="tags[]" id="tags" class="form-control " multiple>
                                    <?php foreach ($tags as $tag) : ?>
                                        ...
                                        <option <?= in_array($tag['id'], $tagIDForPost) ? 'selected' : null ?> value="<?= $tag['id'] ?>"><?= $tag['name'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
